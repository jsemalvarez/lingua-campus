                                ...
                                <tbody className="divide-y divide-border/50">
                                    {filteredTransactions.map((tx) => {
                                        ...
                                        return (
                                            <tr
                                                key={tx.id}
                                                className={`transition-all duration-200 group relative ${isHighlighted
                                            ...
                                            >
                                                <td className="px-5 py-4">
                                                    <div className={`flex items-center gap-3 ${tx.status === "VOIDED" ? "opacity-50 grayscale" : ""}`}>
                                                        <div className={`p-2 rounded-full ${isCancellation
                                                ...
                                                <td className={`px-5 py-4 text-right ${tx.status === "VOIDED" ? "opacity-50" : ""}`}>
                                                    <span className={`font-bold tabular-nums tracking-tight ${isCancellation

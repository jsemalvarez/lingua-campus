...
import { resetGuardianPassword } from "./actions";

export function GuardianDangerZone({ guardianId }: { guardianId: string }) {
    ...
    const handleReset = async () => {
        if (!confirm("¿Estás seguro de restablecer la contraseña de este tutor?")) return;

        setIsResetting(true);
        setError(null);
        setSuccessMessage(null);

        const res = await resetGuardianPassword(guardianId, customPassword || undefined);
                ...
                <div className="space-y-4">
                    <div>
                        ...
                        <p className="text-sm text-muted-foreground mt-1">
                            Permite asignar una nueva contraseña al tutor. Si dejás el campo vacío, se asignará la contraseña por defecto.
                        </p>
                    </div>
